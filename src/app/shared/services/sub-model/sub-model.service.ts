...
import { addDoc, collection, collectionData, doc, DocumentData, Firestore, getDocs, query, QuerySnapshot, where } from '@angular/fire/firestore';
...
export class SubModelService {
  ...
  deleteSubmodel(id:string){
     return deleteDoc(doc(this.firestore, 'sub-model' ,id))
  }
}
